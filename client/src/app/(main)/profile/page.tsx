    ...
    return (
        <div className="min-h-screen bg-(--bg-color) text-(--text-color)">
            ...
            <div className="px-4">
                ...
                <div className="flex justify-between items-start -mt-16">
                    ...
                    <div className="flex items-center gap-2 mt-20">
                        ...
                        {currentUser?.userId === userProfile?.id ?
                            ...
                            (<button className="secondary-btn cursor-pointer px-5" onClick={() => router.push("/edit-profile")}>Edit profile</button>) :
                            (<FollowButton
                ...
                {/* BIO */}
                <p className="text-(--text-color) text-[16px] mt-2">{userProfile?.profile?.bio}</p>
