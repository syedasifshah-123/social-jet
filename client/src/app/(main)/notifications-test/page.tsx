...
const NotificationTestPage = () => {
    ...
    useEffect(() => {
        ...
        newSocket.on('new-notification', (notification) => {
            ...
            // Show toast
            const messages = {
                'like': `❤️ ${notification.sender?.name} liked your post`,
                'comment': `💬 ${notification.sender?.name} commented on your post`,
                'follow': `👤 ${notification.sender?.name} started following you`,
                'new_post': `📝 ${notification.sender?.name} created a new post`
            };

            toast.success(messages[notification.type] || notification.message, {
                duration: 4000,
